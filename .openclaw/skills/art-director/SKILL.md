...
metadata:
  runtime: python3
  dependencies: ["@nadfun/sdk", "scikit-learn", "pillow"]
---
...
3. Fetch token image, extract dominant colors using K-means (`k=3`), and compute buy-vs-sell energy.
4. Overwrite `art-config.json` with style, energy, and token render coordinates.
